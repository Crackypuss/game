...
function new_circle() {
    ...
    var fn = function (time) {
        ...
        } else { // pirmais izsaukums uz requestAnimationFrame iestata sākuma laiku
            startTime = time;
            requestAnimationFrame(fn);
        }
    };
...
function animate() {
    ...
    enemies.forEach((enemy, index) => {
        ...
        projectiles.forEach((projectile, projectileIndex) => {
            ...
            //kad shaujamais pieskaras ienaidniekam
            if (dist - enemy.radius - projectile.radius < 1) {

                //spradziena radishana
                ...
                if (enemy.radius - 10 > 5) {
                    ...
                    //gust punktus no mirusha ienaidnieka
                    score += 250
                    scoreEl.innerHTML = score / 10
                    setTimeout(() => {
                        enemies.splice(index, 1)
    ...
    specials.forEach((special, index) => {
        ...
        //kas bumbina pieskaras speletajam
